...
// Biglife Logo Component for Footer (inverted for dark background)
const BiglifeLogoFooter = ({ className = "w-8 h-8" }: { className?: string }) => (
  <svg 
    width="530" 
    height="530" 
    viewBox="0 0 530 530" 
    ...
    className={className}
  >
    <rect width="530" height="530" rx="101" fill="#ffffff"/>
    <g filter="url(#filter0_d_104_6_footer)">
      <path 
        fillRule="evenodd" 
        clipRule="evenodd" 
    ...
    <defs>
      <filter id="filter0_d_104_6_footer" x="113" y="68" width="243.272" height="395.128" filterUnits="userSpaceOnUse" colorInterpolationFilters="sRGB">
...
export function Footer() {
  ...
  const handleAdminToggle = () => {
    const password = prompt('Zadejte heslo pro admin panel:');
        ...
        <div className="grid md:grid-cols-4 gap-8">
          <div className="md:col-span-2">
            <div className="flex items-center space-x-3 mb-4">
              <BiglifeLogoFooter className="w-10 h-10 drop-shadow-lg" />
              <h3>Biglife</h3>
            </div>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8">
          <div className="text-center md:text-left text-gray-400">
            ...
            <button
              ...
              className="mt-2 text-xs opacity-20 hover:opacity-100 transition-opacity duration-300"
            >
              Admin
            </button>
          </div>
